...
input <- list(ml_perf_metr = "repeatedcv", ml_folds = 5, ml_method = "glmnet", 
          ml_preproc = c("center", "scale"), ml_alpha = 1, ml_lambda = 0, 
          ml_name = "all", ml_train_perc = 60, ml_attempts = 3, ml_top_x = 10)
