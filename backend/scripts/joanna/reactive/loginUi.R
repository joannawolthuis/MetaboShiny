output$currUI <- renderUI({
  if(!local$vars$logged_in){
    ...
    navbarPage(inverse=TRUE,
               ...
               title=div(div(h1("MetaboShiny"),class="outlined"), 
                         tags$head(tags$style(type="text/css", font.css)), # load in user customized css (generated in 'global')
                                                     ...
                                                     tabsetPanel(id = "search", #type = "pills",
                                                                 ...
                                                                 tabPanel(NULL, icon=icon("paint-brush"),
                                                                          ...
                                                                          selectInput("color_ramp", label = "Color scheme", choices = list("RAINBOW!"="rb",
                                                                                                                                           ...
                                                                                                                                           "Pastel2", "Set1", "Set2", "Set3"),selected = options$gspec
                                                                          ),
                                                                          # preview plot
               ...
               div(class="spinnylocation1",
                   div(class="plus", img(class="imagetop", src=options$taskbar_image, width="100px", height="100px")),
                   div(class="minus", img(class="imagebottom", src=options$taskbar_image, width="100px", height="100px"))
               ),
               div(class="line")
               ,footer=fluidRow(div(
