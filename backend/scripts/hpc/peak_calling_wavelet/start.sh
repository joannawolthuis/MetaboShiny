...
scripts="/hpc/cog_bioinf/ridder/users/jwolthuis/Pipelines/changed/Direct-Infusion-Pipeline_2.1_J/scripts"
projdir="/hpc/cog_bioinf/ridder/users/jwolthuis/Data/Metabolomics/DSM/BrSp"
