...
PLSDA.CV("L",5, "Q2")
PlotPLS.Imp("pls_imp_0_", "png", 72, width=NA, "vip", "Comp. 1", 15,FALSE)
PlotPLSPairSummary("pls_pair_1_", "png", 72, width=NA, 5)
PlotPLS2DScore("pls_score2d_1_", "png", 72, width=NA, 1,3,0.95,1,0)
PlotCmpdView("533.3/3897", "png", 72, width=NA)
PlotCmpdView("518.2/3423", "png", 72, width=NA)
PLSDA.CV("L",7, "Q2")
PLSDA.CV("L",7, "R2")
PLSDA.CV("L",7, "Accuracy")
PlotPLS.Imp("pls_imp_1_", "png", 72, width=NA, "vip", "Comp. 1", 15,FALSE)
PlotPLS.Imp("pls_imp_2_", "png", 72, width=NA, "coef", "Overall", 15,FALSE)
PlotPLS.Imp("pls_imp_3_", "png", 72, width=NA, "vip", "Comp. 3", 15,FALSE)
PLSDA.Permut(100, "bw")
PlotPLS.Permutation("pls_perm_1_", "png", 72, width=NA)
PLSDA.Permut(100, "accu")
PlotPLS.Permutation("pls_perm_2_", "png", 72, width=NA)
PlotHCTree("tree_0_", "png", 72, width=NA, "euclidean", "ward.D")
SPLSR.Anal(5, 10, "same")
PlotSPLSPairSummary("spls_pair_0_", "png", 72, width=NA, 5)
PlotSPLS2DScore("spls_score2d_0_", "png", 72, width=NA, 1,2,0.95,1,0)
...
PlotSPLSLoading("spls_loading_0_", "png", 72, width=NA, 1,"overview");
PlotSPLSDA.Classification("spls_cv_0_", "Mfold", "png", 72, width=NA)
PlotSPLSLoading("spls_loading_1_", "png", 72, width=NA, 2,"overview");
PlotSPLSDA.Classification("spls_cv_1_", "Mfold", "png", 72, width=NA)
PlotSPLSDA.Classification("spls_cv_2_", "Mfold", "png", 72, width=NA)
SPLSR.Anal(5, 10, "same")
PlotSPLSPairSummary("spls_pair_1_", "png", 72, width=NA, 5)
PlotSPLS2DScore("spls_score2d_1_", "png", 72, width=NA, 1,2,0.95,1,0)
PlotSPLS3DScore("spls_score3d_1_", "json")
PlotSPLSLoading("spls_loading_2_", "png", 72, width=NA, 1,"overview");
PlotSPLSDA.Classification("spls_cv_3_", "Mfold", "png", 72, width=NA)
OPLSR.Anal()
PlotOPLS2DScore("opls_score2d_0_", "png", 72, width=NA, 1,2,0.95,1,0)
PlotOPLS.Splot("opls_splot_0_", "png", 72, width=NA, "all");
PlotOPLS.MDL("opls_mdl_0_", "png", 72, width=NA)
PlotOPLS.MDL("opls_mdl_0_", "png", 72, width=NA)
PlotHeatMap("heatmap_0_", "png", 72, width=NA, "norm", "row", "euclidean", "ward.D","bwm", "overview", T, T, NA, T, F)
SAM.Anal("d.stat", FALSE, TRUE)
PlotSAM.FDR(0.7, "sam_view_0_", "png", 72, width=NA)
SetSAMSigMat(0.7)
PlotSAM.Cmpd("sam_imp_0_", "png", 72, width=NA)
PlotCmpdSummary("328.2/3633", "png", 72, width=NA)
EBAM.A0.Init(FALSE, TRUE)
PlotEBAM.A0("ebam_view_0_", "png", 72, width=NA)
EBAM.Cmpd.Init("z.ebam", 0.0, FALSE, TRUE)
SetEBAMSigMat(0.9);
PlotEBAM.Cmpd("ebam_imp_0_", "png", 72, width=NA)
