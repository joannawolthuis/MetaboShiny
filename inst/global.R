...
gbl <- list(constants = list(ppm = 2, # TODO: re-add ppm as option for people importing their data through csv
                             ...
                             images = list(list(name = 'load_icon', path = 'www/cute.png', dimensions = c(100, 100)),
                                           ...
                                           list(name = 'chemidplus_logo', path = 'www/chemidplus_logo.png', dimensions = c(300, 60)),
                             ...
                             db.build.info = list(
                               ...
                               chemidplus = list(title = "ChemIDplus",
                                                    description = "(VIA MAGICBALL) ChemIDplus gives you access to structure and nomenclature authority files used to identify chemical substances cited in the National Library of Medicine® (NLM) databases.",
                                                    image_id = "chemidplus_logo"),
