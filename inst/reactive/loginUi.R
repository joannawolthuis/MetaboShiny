output$currUI <- shiny::renderUI({
  if(!is.null(interface$html)){
    if(interface$html != ""){
      print("!!!")
...
interface$html <- {
  if(lcl$paths$opt.loc != ""){
    ...
    html = shiny::tagList(shiny::tags$style(type="text/css", bar.css),
                          shiny::tags$script(src="spinnytitle.js"), 
                          shiny::tags$script(src="sparkle.js"),
                          shiny::navbarPage(windowTitle='MetaboShiny',
                                            inverse=TRUE,
                                            # use this for title
                                            # https://codepen.io/maxspeicher/pen/zrVKLE
                                            title=shiny::div(shiny::h1("MetaboShiny"), class="outlined", shiny::tags$style(type="text/css", font.css), id="sparkley"), # make it use the sparkle.js for unnecessary sparkle effects ;)
                                            id="nav_general",
                                            ...
                                            shiny::tabPanel("data import", icon = shiny::icon("upload", class = "outlined"),
                                                            shiny::fluidRow(shiny::column(12, align="center", 
                                                                                          shiny::textInput("proj_name_new", label = "STEP 1: What is your project name?", value = lcl$proj_name),
                                                                                          shiny::sliderInput("ppm", "STEP 2: What level accuracy is your mass spectrometer?",min = 0.1,max = 50,value = 5,step = .1))),
                                                            shiny::hr(),
                                                            shiny::fluidRow(shiny::column(3, align="center",
                                                                                          shiny::imageOutput("merge_icon",inline = T),
                                                                                          shiny::radioButtons("importmode", label = "", 
                                                                                          ...
                                                                                          shiny::conditionalPanel(condition = "input.importmode == 'db'",
                                                                                                                  shinyFiles::shinyFilesButton('database', 'database', 'Select .db file', FALSE)
                                                                                          ),
                                                                                          shiny::conditionalPanel(condition = "input.importmode == 'csv'",
                                            ...
                                            tabPanel("normalize",  icon = shiny::icon("shower",class = "outlined"), value="filter",
                                                     shiny::fluidRow(shiny::column(3, aligh="center",
                                                                                   shiny::selectInput('samp_var', 'Which variable represents sample amount/concentration?', choices = c("")), #TODO: only show this when normalize by sample specific factor (specnorm) is selected
                                                                                   ...
                                                                                   shinyWidgets::sliderTextInput("perc_limit","Max. missing feature percent:",
                                                                                                                 ...
                                                                                                                 selected=1, grid = T),
                                                                                   shiny::selectInput('filt_type', 'How will you filter your m/z values?', choices = list("Interquantile range"="iqr",
                                                                                                                                                                          "Relative stdev"="rsd",
                                                                                                                                                                          ...
                                                                                                                                                                          "None"="none"),
                                                                                                      selected = "none"),
                                                                                   shiny::selectInput('norm_type', 'What type of normalization do you want to do?', choices = list("Quantile normalization"="QuantileNorm",
                                                                                   ...
                                                                                   shiny::selectInput('trans_type', 'How will you transform your data?', choices = list("Log transform"="LogNorm",
                                                                                                                                                                        "Cubic root transform"="CrNorm",
                                                                                                                                                                        "None"="NULL")),
                                                                                   shiny::selectInput('scale_type', 'How will you scale your data?', choices = list("Autoscale/Z-transform"="AutoNorm",
                                                                                                                                                                    "Mean-center"="MeanCenter",
                                                                                                                                                                    "Pareto Scaling"="ParetoNorm",
                                                                                                                                                                    "Range scaling"="RangeNorm",
                                                                                                                                                                    "None"="NULL")),
                                                                                   shiny::selectInput('miss_type', 'How to deal with missing values?', choices = list("Half feature minimum"="colmin",
                                                            ...
                                                            sidebarLayout(position="right",
                                                                                                                                   ...
                                                                                                                                   shiny::navbarPage(inverse=T, shiny::icon("cube"), id = "dimred",
                                                                                                                                                     ...
                                                                                                                                                     shiny::tabPanel("pca", value = "pca", #icon=shiny::icon("cube"),
                                                                                                                                                                     ...
                                                                                                                                                                     shiny::fluidRow(shiny::column(3,
                                                                                                                                                                                                   shiny::selectInput("pca_x", label = "X axis:", choices = paste0("PC",1:20),selected = "PC1",width="100%"),
                                                                                                                                                                                                   shiny::selectInput("pca_y", label = "Y axis:", choices = paste0("PC",1:20),selected = "PC2",width="100%"),
                                                                                                                                                                                                   shiny::selectInput("pca_z", label = "Z axis:", choices = paste0("PC",1:20),selected = "PC3",width="100%")),
                                                                                                                                                                                     shiny::column(9,
                                                                                                                                                     ...
                                                                                                                                                     shiny::tabPanel("pls-da", value = "plsda",
                                                                                                                                                                     ...
                                                                                                                                                                     shiny::fluidRow(shiny::column(3,
                                                                                                                                                                                                   ...
                                                                                                                                                                                                   shiny::selectInput("plsda_x", label = "X axis:", choices = paste0("PC",1:8),selected = "PC1",width="100%"),
                                                                                                                                                                                                   shiny::selectInput("plsda_y", label = "Y axis:", choices = paste0("PC",1:8),selected = "PC2",width="100%"),
                                                                                                                                                                                                   shiny::selectInput("plsda_z", label = "Z axis:", choices = paste0("PC",1:8),selected = "PC3",width="100%")),
                                                                                                                                                                                     shiny::column(9,
                                                                                                                                                     ...
                                                                                                                                                     shiny::tabPanel(title="venn", value="venn", #icon=shiny::icon("comments"),
                                                                                                                                                                     sidebarLayout(position = "left",
                                                                                                                                                                                   ...
                                                                                                                                                                                   mainPanel = mainPanel(
                                                                                                                                                                                     ...
                                                                                                                                                                                     shiny::fluidRow(shiny::selectInput("intersect_venn", label = "Show hits from (only):", selected = 1,choices = "",multiple = T),
                                                                                                                                                                                                     align="center"),
                                                                                                                                   ...
                                                                                                                                   shiny::navbarPage(inverse=F, shiny::icon("signature"), id = "ml",
                                                                                                                                                     shiny::tabPanel("initialize", value="init",
                                                                                                                                                                     shiny::fluidRow(
                                                                                                                                                                       ...
                                                                                                                                                                       shiny::column(width=3,align="center",
                                                                                                                                                                                     shiny::selectizeInput("ml_exclude_covars", label = "Don't use this metadata:", choices=c(), multiple=TRUE),
                                                                                                                                                     ...
                                                                                                                                                     shiny::tabPanel("results", value="res", icon=shiny::icon("poll"),
                                                                                                                                                                     shiny::br(),
                                                                                                                                                                     shiny::div(shiny::selectInput("show_which_ml", label = "Plot which model?", choices = c())),
                                                                            ...
                                                                            sidebarPanel(align="center",width = 4,
                                                                                                            ...
                                                                                                            shiny::tabPanel(title="search", icon=shiny::icon("search"),
                                                                                                                            ...
                                                                                                                            shinyBS::bsCollapse(shinyBS::bsCollapsePanel(title=shiny::h2("Settings"), style="info",
                                                                                                                                                                         shiny::tabsetPanel(id="tab_iden_1", selected = "start",
                                                                                                                                                                                            # forward searching
                                                                                                                                                                                            shiny::tabPanel(title=shiny::icon("database"),value="start",
                                                                                                                                                                                            ...
                                                                                                                                                                                            shiny::tabPanel(title=shiny::icon("magic"),
                                                                                                                                                                                                            shiny::h2("MagicBall settings"),
                                                                                                                                                                                                            shiny::fluidRow(align="center",MetaboShiny::switchButton(inputId = "magicball_pubchem_cids",
                                                                                                                                                                                                                                                                     label = "Check PubChem for predicted formulas?",
                                                                                                                                                                                                                                                                     col = "BW", type = "YN", value = F)
                                                                                                                                                                                                            ),
                                                                                                                                                                                                            shiny::fluidRow(align="center",MetaboShiny::switchButton(inputId = "magicball_pubchem_details",
                                                                                                                                                                                                                                                                     label = "Get detailed PubChem matches? (SLOW!)",
                                                                                                                                                                                                                                                                     col = "BW", type = "YN", value = F)
                                                                                                                                                                                                            ),
                                                                                                                                                                                                            shiny::fluidRow(align="center", shiny::helpText("Considered adducts:")),
                                                                                                                                                                                                            shiny::fluidRow(shiny::div(DT::dataTableOutput('magicball_add_tab'),style='font-size:100%'),
                                                                                                                                                                                                                            align="center")
                                                                                                                                                                                            ),
                                                                                                                                                                                            shiny::tabPanel(title=shiny::icon("star-half-alt"),
                                                                                                                                                                                                            shiny::selectInput("iso_score_method",
                                                                                ...
                                                                                border-bottom: 1px solid #DFDCDC;")
                                                                                                            ...
                                                                                                            shiny::tabPanel("switch/subset", icon=shiny::icon("exchange")
                                                                                                                            ...
                                                                                                                            ,shiny::fluidRow(align="center", shiny::div(
                                                                      ...
                                                                      border-bottom: 1px solid #DFDCDC;"))
                                                                                                            ...
                                                                                                            shiny::tabPanel("plot aesthetics", icon=shiny::icon("paint-brush"),
                                                                                                                            ...
                                                                                                                            shiny::selectInput("ggplot_sum_stats", label = "Stats shown", choices = list("median", "mean", "none")),
                                                                                                                            shiny::h2("Shape")
                                                                                                                            ,shiny::selectInput("shape_var", label="Marker shape based on:", choices = c("label"))
                                                                                                                            ,shiny::h2("Color")
                                                                                                                            ,shiny::selectInput("col_var", label="Marker color based on:", choices = c("label"))
                                                                                                                            ,shiny::h2("Hover text")
                                                                                                                            ,shiny::selectInput("txt_var", label="Marker hover text based on:", choices = c("label")),
                                                                                                                            shiny::h2("Plot theme"),
                                                                                                                            ...
                                                                                                                            # preview plot
                                                                                                                            shiny::fluidRow(shinycssloaders::withSpinner(plotly::plotlyOutput("ramp_plot",inline = T, width="100%"))),
                                                                                                                            shiny::h2("Discrete data"),
                                                                                                                            shiny::uiOutput("colorPickers") # colour pickers generated in server.R. default settings taken from user_options.txt.
                                                                                                            ))
                                                                            )
                                                            )),
                                            ...
                                            shiny::tabPanel("settings",  icon = shiny::icon("cog",class = "outlined"), value="options",
                                                            shiny::navbarPage(inverse=TRUE,"Settings", id="tab_settings",
                                                                              ...
                                                                              shiny::tabPanel("Adducts", icon=shiny::icon("plus-square"),
                                                                                              ...
                                                                                              shinyFiles::shinySaveButton("save_adducts",
                                                                                                                          "Save changed table",
                                                                                                                          "Save file as ...",
                                                                                              ...
                                                                                              shiny::fileInput("add_tab", "Import adduct table",
                                                                                                               multiple = F,
                                                                                                               accept = c(".RData", ".csv")),
                                                                                              MetaboShiny::sardine(shiny::actionButton("import_adducts", "Import", icon = shiny::icon("hand-peace-o"))),
                                                                                              MetaboShiny::sardine(shiny::imageOutput("adduct_upload_check",inline = T))
                                                                              ),
                                                                              ...
                                                                              shiny::tabPanel("Aesthetic", icon=shiny::icon("child"),
                                                                                              ...
                                                                                              colourpicker::colourInput(inputId = "bar.col.4",
                                                                                                                        ...
                                                                                                                        allowTransparent = FALSE),
                                                                                              shiny::br(),
                                                                                              shiny::h2("Fonts (Google fonts)"),
                                                                                              shiny::textInput(inputId="font.1", label="h1", value = opts$font1),
                                                                                              shiny::textInput(inputId="font.2", label="h2", value = opts$font2),
                                                                                              shiny::textInput(inputId="font.3", label="h3", value = opts$font3),
                                                                                              shiny::textInput(inputId="font.4", label="body", value = opts$font4),
                                                                                              shiny::br(), # TODO: font size modifier slider
                                                                                              shiny::h2("Font size"),
                                                                                              shiny::sliderInput("size.1", label="h1", value=as.numeric(opts$size1),min = 5, max=50),
                                                                                              shiny::sliderInput("size.2", label="h2", value=as.numeric(opts$size2),min = 5, max=50),
                                                                                              shiny::sliderInput("size.3", label="h3", value=as.numeric(opts$size3),min = 5, max=50),
                                                                                              shiny::sliderInput("size.4", label="body", value=as.numeric(opts$size4),min = 5, max=50),
                                                                                              shiny::br(),
                                            ...
                                            ,footer=shiny::fluidRow(
                                              ...
                                              shiny::div(
                                                ...
                                                shiny::actionButton("load_mset", label="load", icon = shiny::icon("folder-open"),style=gsubfn::fn$paste("background-color:$bgcol; border-color:$bgcol;")),
                                                shiny::actionButton("save_mset", label="save", icon = shiny::icon("save"),style=gsubfn::fn$paste("background-color:$bgcol; border-color:$bgcol;")),
                                                shiny::actionButton("debug", label="debug", icon = shiny::icon("bug"),style=gsubfn::fn$paste("background-color:$bgcol; border-color:$bgcol;"))
