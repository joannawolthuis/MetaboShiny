...
function startCursor(){
  ...
  colour="random"; // "random" can be replaced with any valid colour ie: "red"...
   sparkles=100;// increase of decrease for number of sparkles falling
   x=ox=400;
   y=oy=300;
   swide=800;
   shigh=600;
