                                                                                                          ...
                                                                                                          shiny::tabPanel("dimension reduction", value = "dimred",  icon=shiny::icon("cube"),
                                                                                                                          shiny::navbarPage(inverse=T, shiny::icon("cube"), id = "dimred",
                                                                                                                                            ...
                                                                                                                                            shiny::tabPanel("pca", value = "pca", #icon=shiny::icon("cube"),
                                                                                                                                                            shiny::tabsetPanel(shiny::tabPanel("samples",
                                                                                                                                                                               ...
                                                                                                                                                                               shiny::tabPanel("loadings", 
                                                                                                                                                                                               shiny::fluidRow(align="center",shiny::column(12,plotly::plotlyOutput("plot_pca_loadings",height = "600px", width="600px")))#%>% shinycssloaders::withSpinner())),
                                                                                                                                                                               )),
                                                                                                                                            ...
                                                                                                                                            shiny::tabPanel("pls-da", value = "plsda",
                                                                                                                                                            shiny::tabsetPanel(shiny::tabPanel("samples",
                                                                                                                                                                                               shiny::fluidRow(align="center",shiny::column(12,plotly::plotlyOutput("plot_plsda",height = "600px", width="600px")))#%>% shinycssloaders::withSpinner())),
                                                                                                                                                            ),
                                                                                                                                                            shiny::tabPanel("loadings", 
                                                                                                                                                                            shiny::fluidRow(align="center",shiny::column(12,plotly::plotlyOutput("plot_plsda_loadings",height = "600px", width="600px")))#%>% shinycssloaders::withSpinner())),
                                                                                                                                                            )),                                                                                                                                                            shiny::fluidRow(align="center",shiny::column(12,
                                                                                                                                            ...
                                                                                                                                            shiny::tabPanel("enrichment", value = "enrich",
                                                                                                                                                            sidebarLayout(position = "left",
                                                                                                                                                                          ...
                                                                                                                                                                          mainPanel = mainPanel(fluidRow(align="center",
                                                                                                                                                                                               plotly::plotlyOutput("enrich_plot"),
