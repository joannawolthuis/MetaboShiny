                                                                                                         ...
                                                                                                         border-bottom: 1px solid #DFDCDC;")
                                                                                                                   ...
                                                                                                                   shiny::tabsetPanel(id="tab_iden_2",
                                                                                                                                      ...
                                                                                                                                      shiny::tabPanel(title="mz > molecule",value = "mzmol",
                                                                                                                                                      ...
                                                                                                                                                      shinyBS::bsCollapse(shinyBS::bsCollapsePanel(title=shiny::h2("Search results"), value="panel3",
                                                                                                                                                                                                   shiny::tabsetPanel(id="tab_iden_4",selected = "start",
                                                                                                                                                                                                                      # forward searching
                                                                                                                                                                                                                      shiny::tabPanel(title=shiny::icon("table"), value="start",
                                                                                                                                                                                                                                      shiny::fluidRow(align="center",
                                                                                                                                                                                                                                                      shiny::imageOutput("empty",width="100%",height="1px"),br(),
                                                                                                                                                                                                                                                      sardine(shiny::icon("plus-circle")), 
                                                                                                                                                                                                                                                      sardine(shiny::div(verbatimTextOutput("curr_add"),style='font-size:60%;padding:2px')), 
                                                                                                                                                                                                                                                      sardine(shiny::icon("percentage")), 
                                                                                                                                                                                                                                                      sardine(shiny::div(verbatimTextOutput("curr_iso"),style='font-size:60%;padding:2px')),
                                                                                                                                                                                                                                                      # sardine(shiny::icon("database")), 
                                                                                                                                                                                                                                                      # sardine(shiny::div(verbatimTextOutput("curr_db"),style='font-size:60%;padding:2px')),
                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                      shiny::tabPanel(title=shinyBS::tipify(shiny::icon("filter"),
                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                      shinyWidgets::verticalTabsetPanel(id = "match_filters",
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        #   plotly::plotlyOutput("match_pie_db",width = "100%")
                                                                                                                                                                                                                                        # ),
                                                                                                                                                                                                                                        shinyWidgets::verticalTabPanel(box_height = "80px",
                                                                                                                                                                                                                                          title = NULL, icon = icon("plus","fa-2x"),value = "pie_add",
                                                                                                                                                                                                                                          plotly::plotlyOutput("match_pie_add",width = "100%")
                                                                                                                                                                                                                                        ),
                                                                                                                                                                                                                                        shinyWidgets::verticalTabPanel(box_height = "80px",
