                                   ...
                                   shiny::tabPanel("data import", icon = shiny::icon("upload", class = "outlined"),
                                                   shiny::fluidRow(align="center",
                                                                   shiny::column(12,
                                                                                 ...
                                                                                 shinyWidgets::sliderTextInput("perc_limit_samp","STEP 3: What percentage missing m/z for a sample is allowed?",
                                                                                                               choices=c(0, 0.0001, 0.001, 0.01, 0.1, seq(1, 100, 1)),
                                                                                                               selected=100, grid = T),
                                                                                 shinyWidgets::sliderTextInput("perc_limit_mz","STEP 4: What percentage missing samples for a m/z value is allowed?",
                                                                                                               choices=c(0, 0.0001, 0.001, 0.01, 0.1, seq(1, 100, 1)),
                                                                                                               selected=5, grid = T))
                                                   ),
                                                   shiny::hr(),
