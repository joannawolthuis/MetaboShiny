shiny::fluidPage(theme = "metaboshiny.css",class="hidden",id="metshi",
                 ...
                 shiny::navbarPage(windowTitle='MetaboShiny',
                                   ...
                                   shiny::tabPanel("database", icon = shiny::icon("database",class = "outlined"), value="database",
                                                   shiny::fluidRow(align="center", shinyBS::bsCollapse(shinyBS::bsCollapsePanel(title=shiny::h2("Settings"), style="info",value="panel4",
                                                                                                                                                            ...
                                                                                                                                                            shiny::fluidRow(
                                                                                                                                                              ...
                                                                                                                                                              shiny::column(width=6,align="center",
                                                                                                                                                                            ...
                                                                                                                                                                            shinyWidgets::radioGroupButtons(
                                                                                                                                                                              ...
                                                                                                                                                                              choices = c(`<i class='fa fa-arrow-down'></i> downsample` = "down", `do nothing` = "none", 
                                                                                                                                                                                                   ...
                                                                                                                                                                                                   tabsetPanel(id="wordclouds", selected = "settings", type = "pills",
                                                                                                                                                                                                               tabPanel(title="settings",
                                                                                                                                                                                                                        fluidRow(align = "center",
                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                 actionButton("wordcloud_go", "Plot")
                                                                                                                                                                                                                        )),
                                                                                                         ...
                                                                                                         border-bottom: 1px solid #DFDCDC;")
                                                                                                                   ...
                                                                                                                   shiny::tabsetPanel(id="tab_iden_2",
                                                                                                                                      ...
                                                                                                                                      shiny::tabPanel(title="mz > molecule",value = "mzmol",
                                                                                                                                                      ...
                                                                                                                                                      shinyBS::bsCollapse(shinyBS::bsCollapsePanel(title=shiny::h2("Search results"), style="error",value="panel3",
                                                                                                                                                                                                   shiny::tabsetPanel(id="tab_iden_4",selected = "start",
                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                      shiny::tabPanel(title=shiny::icon("table"), value="start",
                                                                                                                                                                                                                                      shiny::fluidRow(align="center",
                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                      sardine(shiny::icon("plus-circle", class = "fa-xs")), 
                                                                                                                                                                                                                                                      sardine(shiny::div(textOutput("curr_add"),style='font-size:50%')), 
                                                                                                                                                                                                                                                      sardine(shiny::icon("percentage", class = "fa-xs")), 
                                                                                                                                                                                                                                                      sardine(shiny::div(textOutput("curr_iso"),style='font-size:50%')),
                                                                                                                                                                                                                                                      sardine(shiny::icon("database", class = "fa-xs")), 
                                                                                                                                                                                                                                                      sardine(shiny::div(textOutput("curr_db"),style='font-size:50%')),
                                                                                                                                                      ...
                                                                                                                                                      shiny::fluidRow(align="center",
                                                                                                                                                                      ...
                                                                                                                                                                      shiny::tabsetPanel(
                                                                                                                                                                        shiny::tabPanel(NULL, icon = shiny::icon("database"),
                                                                                                                                                                                        shiny::tabsetPanel(id="tab_iden_6",
                                                                                                                                                                                                           shiny::tabPanel(title=shiny::icon("atlas"),
                                                                                                                                                                                                                           wellPanel(id = "def",style = "overflow-y:scroll; max-height: 200px",
                                                                                                                                                                                                                                     shiny::fluidRow(align="center",shiny::textOutput("browse_definition")))
                                                                                                                                                                                                           ),
                                                                                                                                                                                                           shiny::tabPanel(title=shiny::icon("atom"),
                                                                                                                                                                                                                           shiny::fluidRow(align="center",shiny::uiOutput("curr_formula_rev")),
                                                                                                                                                                                                                           shiny::fluidRow(align="center",
                                                                                                                                                                                                                                           shiny::plotOutput("curr_struct_rev",inline=T))
                                                                                                                                                                                                           )
                                                                                                                                                                                        ),
                                                                                                                                                                                        shiny::imageOutput("empty_rev",width="100%",height="1px"),# for finding the width of the molecule rendering;
                                                                                                                                                                                        shiny::div(DT::dataTableOutput('browse_tab'),style='font-size:80%'),
                                                                                                                                                                                        br(),
                                                                                                                                                                                        shiny::tabsetPanel(id = "tab_iden_5",
                                                                                                                                                                                                           shiny::tabPanel(title=shiny::icon("table"), value="revmatches",
                                                                                                                                                                                                           ...
                                                                                                                                                                                                           shiny::tabPanel(title=shiny::icon("plus"), value = "pie_add",
                                                                                                                                                                                                                           shiny::fluidRow(align = "center",
                                                                                                                                                                                                                                           shinycssloaders::withSpinner(plotly::plotlyOutput("rev_match_pie_add"))
                                                                                                                                                                                                                           )
                                                                                                                                                                                                           ),
                                                                                                                                                                                                           shiny::tabPanel(title=shiny::icon("percentage"), value = "pie_iso",
                                                                                                                                                                                                                           shiny::fluidRow(align = "center",
                                                                                                                                                                                                                                           shinycssloaders::withSpinner( plotly::plotlyOutput("rev_match_pie_iso"))
                                                                                                                                                                                                                           )
                                                                                                                                                                                                           )
                                                                                                                                                                                        ))
                                                                                                                                                                      ))
