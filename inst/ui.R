                                                                                                                   ...
                                                                                                                   shinyBS::bsCollapse(shinyBS::bsCollapsePanel(title=shiny::h2("Settings"), style="info",
                                                                                                                                                                shiny::tabsetPanel(id="tab_iden_1", selected = "start",
                                                                                                                                                                                   ...
                                                                                                                                                                                   shiny::tabPanel(title=shiny::icon("magic"),
                                                                                                                                                                                                   ...
                                                                                                                                                                                                   shiny::fluidRow(align="center",MetaboShiny::switchButton(inputId = "predict_details",
                                                                                                                                                                                                                                                            label = "Get detailed PubChem matches? (SLOW!)",
                                                                                                                                                                                                                                                            col = "BW", type = "YN", value = F)),
                                                                                                                                                                                                   shiny::fluidRow(align="center",MetaboShiny::switchButton(inputId = "predict_structure_check",
                                                                                                                                                                                                                                                            label = "Uniformize ChemSpider/PubChem found structures?",
                                                                                                                                                                                                                                                            col = "BW", type = "YN", value = T)),
                                                                                                                                                                                                   shiny::fluidRow(align="center",MetaboShiny::switchButton(inputId = "predict_adduct_rules",
