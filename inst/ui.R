                 ...
                 shiny::navbarPage(windowTitle='MetaboShiny',
                                   ...
                                   shiny::tabPanel("data import", icon = shiny::icon("upload", class = "outlined"),
                                                   shiny::fluidRow(align="center",
                                                                   shiny::column(3,shiny::textInput("proj_name_new", label = "STEP 1: What is your project name?", value = "")),
                                                                   shiny::column(3,shiny::sliderInput("ppm", "STEP 2: What level accuracy does your mass spectrometer have?",min = 0.01,max = 50,value = 3,step = .01)),
                                                                   shiny::column(3,shinyWidgets::sliderTextInput("perc_limit_samp","STEP 3: What percentage missing m/z for a sample is allowed?",
                                                                                                                 choices=c(0, 0.0001, 0.001, 0.01, 0.1, seq(1, 100, 1)),
                                                                                                                 selected=100, grid = T)),
                                                                   shiny::column(3,shinyWidgets::sliderTextInput("perc_limit_mz","STEP 4: What percentage missing samples for a m/z value is allowed?",
                                                                                                                 choices=c(0, 0.0001, 0.001, 0.01, 0.1, seq(1, 100, 1)),
                                                                                                                 selected=5, grid = T))
                                                   ),
                                                   shiny::hr(),
                                                   shiny::fluidRow(align="center",shiny::column(5,
                                                                                                ...
                                                                                                shiny::tags$b("STEP 5: Click buttons to load data."),
                                                                                                br(),br(),
                                                                                       ...
                                                                                       shiny::tabsetPanel(id="statistics", selected = "inf",
                                                                                                          ...
                                                                                                          shiny::navbarMenu("per m/z", icon=shiny::icon("fingerprint", "fa-2x"), menuName = "permz",
                                                                                                                            ...
                                                                                                                            shiny::tabPanel("pattern", value="pattern",
                                                                                                                                            shiny::fluidRow(align="center",
                                                                                                                                                            shinyBS::bsCollapse(id="collapse_pattern",shinyBS::bsCollapsePanel(title = h2("settings"),value="collapse_pattern_settings",
                                                                                                                                                                                                                               uiOutput('jqui_ui'), br(),
                                                                                                                                                            ...
                                                                                                                                                            shinyBS::bsCollapsePanel(title = h2("plots"),value="collapse_pattern_plots",
                                                                                                                                                                                     shiny::uiOutput("pattern_plot_wrap"),
                                                                                                                                                                                     shiny::sliderInput('pattern_topn',label = "Show top:",min = 5,max=200,value = 25)
                                                                                                                                                            ),
                                                                                                                                                            shinyBS::bsCollapsePanel(title = h2("tables"),value="collapse_pattern_tables",
                                                                                                                            ...
                                                                                                                            shiny::tabPanel("volcano plot", value="volc",
                                                                                                                                            shiny::fluidRow(align="center",
                                                                                                                                                            shinyBS::bsCollapse(multiple=T, id="collapse_volc",
                                                                                                                                                                                shinyBS::bsCollapsePanel(title = h2("settings"),value="collapse_volc_settings",
                                                                                                                                                                                                         shinyWidgets::actionBttn(
                                                                                                                                                                                                           inputId = "do_volc",
                                                                                                ...
                                                                                                shiny::tabsetPanel(id = "anal_sidebar", selected="start",
                                                                                                                   ...
                                                                                                                   shiny::tabPanel(value="search",title=shinyBS::tipify(shiny::icon("search"),
                                                                                                                                   ...
                                                                                                                                   shinyBS::bsCollapse(shinyBS::bsCollapsePanel(title=shiny::h2("Settings"), 
                                                                                                                                                                                value="search_panel",
                                                                                                                                                                                shiny::tabsetPanel(id="tab_iden_1", selected = "search",
                                                                                                                                                                                                   # forward searching
                                                   ...
                                                   shiny::tabsetPanel(id="tab_settings",
                                                                      ...
                                                                      shiny::tabPanel("Formula prediction & lookup", 
                                                                                      ...
                                                                                      MetaboShiny::switchButton(inputId = "predict_adduct_rules",
                                                                                                                ...
                                                                                                                col = "BW", type = "YN", value = F))),
                                                                      shiny::tabPanel(title="Isotope scoring",
