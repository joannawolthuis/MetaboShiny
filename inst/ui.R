                                            ...
                                            shiny::fluidRow(align="center",shiny::column(3, 
                                                             ...
                                                             navbarPage(inverse=F,shiny::h3("explore"),
                                                                        tabPanel("m/z values",# icon=shiny::icon("braille"),
                                                                                 shiny::fluidRow(shiny::column(6,shiny::uiOutput("var1_wrap",height='300px')),
                                                                                                 shiny::column(6,shiny::uiOutput("var3_wrap", height='300px'))
                                                                                 ),
                                                                                 shiny::fluidRow(shiny::column(6,shiny::uiOutput("var2_wrap", height='500px')),
                                                                                                 shiny::column(6,shiny::uiOutput("var4_wrap", height='500px')))
                                                                        ),
                                                                        shiny::tabPanel("samples",# icon=shiny::icon("tint"),
                                                                                        shiny::fluidRow(shiny::column(6,shiny::uiOutput("samp1_wrap",height='300px')),
                                                                                                        shiny::column(6,shiny::uiOutput("samp3_wrap", height='300px'))
                                                                                        ),
                                                                                        shiny::fluidRow(shiny::column(6,shiny::uiOutput("samp2_wrap", height='500px')),
                                                                                                        shiny::column(6,shiny::uiOutput("samp4_wrap", height='500px')))
                                                                        )
                                                             )
                                            )
                                            )),
                                                                                                                          ...
                                                                                                                          shiny::navbarPage(inverse=T, shiny::icon("cube"), id = "dimred",
                                                                                                                                            ...
                                                                                                                                            shiny::tabPanel("pca", value = "pca", #icon=shiny::icon("cube"),
                                                                                                                                                            shiny::tabsetPanel(shiny::tabPanel("samples",
                                                                                                                                                                                               shiny::fluidRow(align="center",shiny::column(12, shiny::uiOutput("plot_pca_wrap")
                                                                                                                                                                               ))),
                                                                                                                                                                               shiny::tabPanel("loadings", 
                                                                                                                                                                                               shiny::fluidRow(align="center",shiny::column(12,shiny::uiOutput("plot_pca_loadings_wrap")
                                                                                                                                                                               )))),
                                                                                                                                                            shiny::fluidRow(align="center",shiny::column(12,
                                                                                                                                                                            ...
                                                                                                                                                                            shiny::column(9,
                                                                                                                                                                                          shiny::tabsetPanel(id="pca_2",
                                                                                                                                                                                                             ...
                                                                                                                                                                                                             shiny::tabPanel(title="Scree",
                                                                                                                                                                                                                             shiny::uiOutput("pca_scree_wrap", width = "100%", height="250px")
                                                                                                                                                                                                             ),
                                                                                                                                            ...
                                                                                                                                            shiny::tabPanel("pls-da", value = "plsda",
                                                                                                                                                            shiny::tabsetPanel(shiny::tabPanel("samples",
                                                                                                                                                                                               shiny::fluidRow(align="center",shiny::column(12,shiny::uiOutput("plot_plsda_wrap")))),
                                                                                                                                                                               shiny::tabPanel("loadings", 
                                                                                                                                                                                               shiny::fluidRow(align="center",shiny::column(12,shiny::uiOutput("plot_plsda_loadings_wrap")
                                                                                                                                                                                               )))),
                                                                                                                                            ...
                                                                                                                                            shiny::tabPanel("t-sne", value = "tsne",
                                                                                                                                                            shiny::fluidRow(align="center",shiny::column(12,shiny::uiOutput("tsne_plot_wrap")),
                                                                                                                                                            shiny::fluidRow(align="center",shiny::column(12,
                                                                                                          ...
                                                                                                          shiny::tabPanel("per m/z", value = "permz", icon=shiny::icon("fingerprint"),
                                                                                                                          shiny::navbarPage(inverse=T, shiny::icon("fingerprint"), id = "permz",
                                                                                                                                            shiny::tabPanel("t-test", value="tt",
                                                                                                                                                            shiny::fluidRow(shiny::uiOutput('summary_plot_wrap',width="100%")),
                                                                                                                                                            shiny::fluidRow(align="center",
                                                                                                                                                            ...
                                                                                                                                                            shiny::navbarPage(inverse=F,"",
                                                                                                                                                                              ...
                                                                                                                                                                              ,shiny::tabPanel("", icon=shiny::icon("area-chart"),
                                                                                                                                                                                               shinycssloaders::withSpinner(shiny::uiOutput('tt_overview_plot_wrap',height="300px"))
                                                                                                                                                                              )
                                                                                                                                                            )),
                                                                                                                                            shiny::tabPanel("anova", value="aov",
                                                                                                                                                            ...
                                                                                                                                                            shiny::navbarPage(inverse=F,"",
                                                                                                                                                                              ...
                                                                                                                                                                              ,shiny::tabPanel("", icon=shiny::icon("area-chart"),
                                                                                                                                                                                               shinycssloaders::withSpinner(shiny::uiOutput('aov_overview_plot_wrap',height="300px"))
                                                                                                                                                                              )
                                                                                                                                                            )),
                                                                                                                                            shiny::tabPanel("fold-change", value="fc",
                                                                                                                                                            ...
                                                                                                                                                            shiny::navbarPage(inverse=F,"",
                                                                                                                                                                              ...
                                                                                                                                                                              ,shiny::tabPanel("", icon=shiny::icon("area-chart"),
                                                                                                                                                                                               shinycssloaders::withSpinner(shiny::uiOutput('fc_overview_plot_wrap',height="300px"))
                                                                                                                                                                              ))
                                                                                                                                            ),
                                                                                                                                            ...
                                                                                                                                            shiny::tabPanel("pattern", value="pattern",
                                                                                                                                                            ...
                                                                                                                                                            shiny::fluidRow(align="center", 
                                                                                                                                                                            ...
                                                                                                                                                                            shiny::uiOutput('pattern_plot_wrap', height="600px"),
                                                                                                          ...
                                                                                                          shiny::tabPanel("overview analyses", value = "overview", icon=shiny::icon("globe"),
                                                                                                                          shiny::navbarPage(inverse=T, shiny::icon("globe"), id = "overview",
                                                                                                                                            shiny::tabPanel("volcano plot", value="volc",
                                                                                                                                                            shiny::fluidRow(shinycssloaders::withSpinner(shiny::uiOutput('volc_plot_wrap',width="100%",height="600px"))),
                                                                                                                                                            shiny::fluidRow(shiny::div(DT::dataTableOutput('volc_tab',width="100%"),style='font-size:80%'))
                                                                                                                                            ),
                                                                                                                                            shiny::tabPanel("heatmap", value="heatmap",
                                                                                                                                                            shinycssloaders::withSpinner(shiny::uiOutput("heatmap")),
                                                                                                                                                            shiny::br(),
                                                                                                                                            ...
                                                                                                                                            shiny::tabPanel("power calculation", value="power",
                                                                                                                                                            shiny::fluidRow(align="center", shiny::uiOutput('power_plot_wrap')),
                                                                                                                                            ...
                                                                                                                                            shiny::tabPanel("results", value="res", icon=shiny::icon("poll"),
                                                                                                                                                            ...
                                                                                                                                                            shiny::navbarPage(title=shiny::icon("poll"),id="ml_results",inverse=F,
                                                                                                                                                                              ...
                                                                                                                                                                              shiny::tabPanel("importance",value= "bar",icon=shiny::icon("star"),
                                                                                                                                                                                              shiny::fluidRow(shiny::uiOutput("ml_bar_wrap")),
                                                                                                                                                                                              shiny::fluidRow(
                                                                                ...
                                                                                shiny::fluidRow(align="center",
                                                                                                shiny::tabsetPanel(id = "anal_sidebar", selected="switch/subset",#type = "pills",
                                                                                                                   shiny::tabPanel(title=shinyBS::tipify(shiny::icon("file"), 
                                                                                                                                   ...
                                                                                                                                   shinyWidgets::circleButton("export_plot_wrap", icon=shiny::icon("hand-o-up"))),
                                                                                                                                   ...
                                                                                                                                   shinyBS::bsCollapse(shinyBS::bsCollapsePanel(title=shiny::h2("Settings"), 
                                                                                                                                                                                ...
                                                                                                                                                                                shiny::tabsetPanel(id="tab_iden_1", selected = "start",
                                                                                                                                                                                                   ...
                                                                                                                                                                                                   shiny::tabPanel(title=shiny::icon("chart-bar"),
                                                                                                                                                                                                                   shinycssloaders::withSpinner(shiny::uiOutput("curr_plot_wrap")
                                                                                                                                                                                                   ),
                                                                                                                   ...
                                                                                                                   shiny::tabPanel(value="plot aesthetics", title=shinyBS::tipify(shiny::icon("paint-brush"), 
                                                                                                                                                   ...
                                                                                                                                                   shiny::uiOutput("ggplot_theme_example",inline = F, width="100%"),
